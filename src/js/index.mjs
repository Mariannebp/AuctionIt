...
if ((path === "/AuctionIt/index.html") || (path === "/index.html")) {
...
} else if ((path === "/AuctionIt/pages/login.html") || (path === "/pages/login.html")) {
  handler.setLoginUserFormListener();
} else if ((path === "/AuctionIt/pages/register.html") || (path === "/pages/register.html")) {
  handler.setRegisterUserFormListener();
} else if ((path === "/AuctionIt/pages/profile.html") || (path === "/pages/profile.html")) {
  profile.checkIfLoggedIn();
  ...
  handler.setUpdateAvatarListener();
  handler.logoutListener();
} else if ((path === "/AuctionIt/pages/auctions.html") || (path === "/pages/auctions.html")) {
  profile.checkIfLoggedIn();
  ...
  handler.setUpdateAvatarListener();
  handler.logoutListener();
} else if ((path === "/AuctionIt/pages/auction-specific.html") || (path === "/pages/auction-specific.html")) {
  profile.checkIfLoggedIn();
  profile.checkIfLoggedInContent();
